...
import com.example.AlumniInternProject.user.HttpResponse;
...
import static com.example.AlumniInternProject.user.filter.SecurityConstants.ACCESS_DENIED_MESSAGE;
